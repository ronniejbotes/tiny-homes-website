...
export const products: Product[] = [
  ...
  },
  {
    ...
    description:
      "DIY garage kits are the fast, affordable way to add secure, weatherproof storage — a garage, workshop or store-room you build yourself. Each kit is delivered flat-packed with a galvanised-steel frame, wall and roof sheeting, fixings and instructions, sized to bolt together on a level slab over a weekend. Choose from two sizes: the 6 × 3 m single garage (18 m²) from R49 900 ex VAT, or the 6 × 6 m double (36 m²) at R84 900 — both 3.6 m to the wall. Delivered nationwide, with slab and assembly available from our turnkey team.",
    startingPrice: 49900,
    sizeLabel: "18 – 36 m²",
    setupTime: "Self-assembly kit",
    dims: { length: 6, width: 6, height: 3.6 },
    specs: [
      { label: "Sizes", value: "6 × 3 m (18 m²) or 6 × 6 m (36 m²)" },
    ...
    variants: [
      { id: "garage-6x3", name: "Single Garage Kit (6 × 3 m)", size: "18 m²", price: 49900, description: "6 × 3 × 3.6 m single garage kit — flat-packed for self-assembly." },
      { id: "garage-6x6", name: "Double Garage Kit (6 × 6 m)", size: "36 m²", price: 84900, description: "6 × 6 × 3.6 m double garage kit — flat-packed for self-assembly." },
    ],
    options: [],
    faqs: [
      ...
      { q: "What sizes are available?", a: "Two: 6 × 3 m (18 m²) and 6 × 6 m (36 m²), both 3.6 m to the wall." },
