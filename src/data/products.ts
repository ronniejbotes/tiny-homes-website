...
export const products: Product[] = [
  {
    ...
    summary:
      "The X-Fold folding home flips from flat-pack to a fully enclosed, insulated 15 m² room in minutes — the most affordable way into tiny living in South Africa, from R54 950 ex VAT.",
    description:
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes — 50 mm insulated, fireproof wall panels keep the unit comfortable in both summer and winter, and optional premium insulation upgrades are available.",
      },
    ],
    seoKeywords: [
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Walls", value: "50 mm insulated, fireproof panels" },
      { label: "Layouts", value: "Studio, 1, 2 or 3 bedrooms — or open shell" },
    ...
    variants: [
      ...
      { id: "b40-slim", name: "B40 Slim", size: "48 m²", price: 450000, description: "Long-format shell with generous open-plan living space." },
      { id: "b40", name: "B40", size: "72 m²", price: 600000, description: "Fully specced three-bedroom family home." },
    ],
    ...
    faqs: [
      {
        ...
        a: "The range runs from the 27.5 m² B20 Slim studio to the 72 m² B40, a fully specced three-bedroom home priced around R600 000 ex VAT.",
      },
      {
        q: "How long does installation take?",
        a: "The module glides outward on site in under two hours. With foundations ready and services connected, most homes are livable the same week they arrive.",
      },
      {
  ...
  },
  {
    ...
    description:
      "Nature cabins are built for places worth waking up in. Each 21 m² cabin pairs a warm timber-look exterior with a tough steel structure, arriving with a 1.8 m deck that settles lightly onto beach, bush or mountain sites without heavy groundwork. Inside, a light-filled space with room for a queen bed, kitchenette and bathroom makes it a natural fit for guest farms, lodges, Airbnb hosts and anyone carving out a retreat on their own land.",
    startingPrice: 375000,
    sizeLabel: "21 m² + deck",
    setupTime: "1–2 days",
    dims: { length: 7.2, width: 3.3, height: 3.1 },
    specs: [
      { label: "Floor area", value: "21 m² plus 1.8 m deck" },
      { label: "Structure", value: "Steel frame, timber-look cladding" },
      { label: "Deck", value: "1.8 m covered deck included" },
      { label: "Siting", value: "Beach, bush and mountain sites" },
      { label: "Layout", value: "Open-plan with bathroom partition" },
      { label: "Finish", value: "Interior lining, LED lighting" },
    ],
    features: [
      "Timber aesthetics with steel durability and low maintenance",
      "Included 1.8 m deck for outdoor living",
      "Light footprint — minimal groundwork required",
    ...
    faqs: [
      {
        ...
        a: "Nature cabins are engineered to drop lightly into beach, bush or mountain sites with minimal groundwork — a level set of plinths is usually enough.",
      },
      {
        q: "Are nature cabins good for Airbnb and guest farms?",
        a: "Yes — the 21 m² layout plus deck comfortably hosts two guests, and turnkey interior options make it easy to run as hospitality accommodation.",
      },
      {
  ...
  },
  {
    ...
    description:
      "The Dome is a beautifully curved, light-filled structure that dissolves the line between inside and out. Its anti-UV polycarbonate panels, arched aluminium doors and windows, and blackout curtain system create a comfortable, private cocoon with panoramic views of sky and landscape — ideal for luxury glamping, boutique dining, stargazing suites and standout hospitality experiences. Professional installation takes just 2–3 days.",
    ...
    useCases: ["Luxury glamping", "Stargazing suite", "Boutique dining", "Airbnb experience", "Garden lounge", "Event space"],
    options: standardOptions(1),
    faqs: [
      {
        q: "Does The Dome get hot in the South African sun?",
        a: "The polycarbonate panels carry an anti-UV coating and the blackout curtain system lets you control light and heat. Ventilation and climate-control options keep the interior comfortable year-round.",
      },
      {
      ...
      },
      {
        ...
        a: "Most owners run it as luxury glamping or boutique hospitality — stargazing suites, spa rooms, garden lounges and standout Airbnb listings.",
      },
    ],
    seoKeywords: [
  ...
  },
  {
    ...
    specs: [
      { label: "Internal area", value: "36.8 m²" },
    ...
    features: [
      ...
      "Fitted kitchen area pre-installed",
    ...
    faqs: [
      {
        ...
        a: "Each cabin ships with a fitted kitchen, bathroom with rainfall shower and stone vanity, HVAC climate control, geyser, smart-lock entry and full electrical and plumbing systems.",
      },
      {
      ...
      },
      {
        ...
        a: "Cabins arrive in modular segments on flatbed trucks and bolt together on a simple plinth foundation. A four-person crew completes assembly in 2–3 days.",
      },
    ],
    seoKeywords: [
  ...
  },
  {
    ...
    description:
      "Glamping Capsules are the flagship of the Tiny Homes SA range — sleek, future-forward shells wrapped in 270 degrees of floor-to-ceiling glass. The two-room layout sleeps two adults in a queen bed, with a central bathroom, rainfall shower, stone vanity, fitted kitchen and HVAC throughout. Lodges and vineyards run them at R2 500 – R4 000 a night, with most operators reaching return on investment in 18–24 months. Crane-assisted installation takes 2–3 days.",
